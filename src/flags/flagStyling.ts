...
export function processRenderedFlags(element: HTMLElement, _ctx: MarkdownPostProcessorContext): void {
	...
	marks.forEach((mark) => {
		...
		mark.classList.add('long-view-inline-flag', `long-view-inline-flag-${typeLower}`);
